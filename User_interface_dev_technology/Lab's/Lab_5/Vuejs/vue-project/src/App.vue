        ...
        infoBlocks: [
                {
                    percent: "100%",
                    progress_count: "100%",
                    context: "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Netus eget velit quisque accumsan amet tortor. Velit, volutpat egestas fringilla mi porttitor tempus. Placerat dui."
                },
                {
                    percent: "75%",
                    progress_count: "75%",
...
<style lang="scss">
  ...
  .time-blocks
  {
    @include flexer(25px, flex-start, center);
  }
</style>